...
import { bsc, bscTest, goerli, rinkeby, mainnet, ethwMainnet, onusTestnet, onusMainnet  } from '@pancakeswap/wagmi/chains'
...
const CHAINS = [bsc, bscTest, rinkeby, goerli, ethwMainnet, onusTestnet, onusMainnet ]
